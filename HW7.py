# -*- coding: utf-8 -*-
"""
Created on Tue Nov  9 15:23:34 2021
...
st.markdown ("[kaihao Zhang](https://github.com/tyb0v0)")
st.markdown ("[Zhiyang Jiang](https://github.com/Bill663)")

x = st.slider("Select the number of iterations",0,1000,1)
